...
**Commit POS layout:** `5094d5d` · alineación: `../03-pos-vendedor/POS_ALINEACION_CURSOR_GROK.md` §13
...
Panel búsqueda: portal en `body` con clase `pos-search-suggestions--portal-alta` · altura CSS hasta ~78vh. Revert: `../03-pos-vendedor/POS_REVERT_DOCK_BUSQUEDA.md`.
