  ...
  function renderResultado(data) {
    ...
    if (els.acciones) {
      ...
      var lizBtn = data.liz_prompt
        ? '<button type="button" class="fc-btn fc-btn--ghost" id="fcAskMaylen">Preguntar a Maylén</button>'
        : '';
      ...
      var askMaylen = document.getElementById('fcAskMaylen');
      if (askMaylen && data.liz_prompt) {
        askMaylen.addEventListener('click', function () {
