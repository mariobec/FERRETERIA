...
- Complete **Nombre** (obligatorio), **Categoría**, opcional **Código Chilemat/referencia**, **Cantidad inicial** y guarde.
- Se crea el producto con **barras** = lo escaneado, **interno** automático y stock según cantidad.
